...
from source.GANLearner_ttur import GANLearner
...
flags.DEFINE_string("dataset_dir", "D:\\Linux\\upload\\dataset\\sequences\\09\\image_0", "Dataset directory")
flags.DEFINE_string("output_dir", "D:\\Python\\bishe\\evaluate\\pose\\09", "Output directory")
flags.DEFINE_string("ckpt_file", "D:\\Python\\bishe\\train_record\\11\\model-1188810", "checkpoint file")
FLAGS = flags.FLAGS
...
def load_image_sequence(dataset_dir, 
    ...
    for o in range(-half_offset, half_offset+1):
        ...
        curr_img = cv2.resize(curr_img, (img_width, img_height), interpolation=cv2.INTER_AREA)
...
def main():
    gan = GANLearner()
    gan.setup_inference(FLAGS.img_height,
                        FLAGS.img_width,
                        'pose',
                        FLAGS.seq_length)
    ...
    with tf.Session() as sess:
        ...
        for tgt_idx in range(N):
            ...
            image_seq = load_image_sequence(FLAGS.dataset_dir, 
                                            ...
                                            FLAGS.img_height, 
                                            FLAGS.img_width)
            pred = gan.inference(image_seq[None, :, :, :], sess, mode='pose')
